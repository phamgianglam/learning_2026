...
export default function Navbar() {
    ...
    const logoStyle = "h-[90%] aspect-square";
    const buttonStyle = "h-[90%] hover:bg-gray-500 rounded-xl ml-2 aspect-square"
    const inputSyle = "bg-white h-[90%] ml-auto mr-20 w-[50%] border rounded-xl p-2"
